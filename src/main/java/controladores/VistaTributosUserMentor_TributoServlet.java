...
public class VistaTributosUserMentor_TributoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 ...
	 protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
	            ...
	            request.getRequestDispatcher("formularios/vista_tributos_user_mentor_tributo.jsp").forward(request, response);
	        } catch (Exception e) {
	            e.printStackTrace();
