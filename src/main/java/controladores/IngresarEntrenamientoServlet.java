...
public class IngresarEntrenamientoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 ...
	 protected void doPost(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
	            ...
	            // Crear una instancia de EntrenamientoDao para realizar la inserción
	            EntrenamientoDao entrenamientoDao = new EntrenamientoDao();

	            // Insertar el entrenamiento en la base de datos
	            entrenamientoDao.insertarEntrenamiento(entrenamiento);
	            ...
	            request.setAttribute("error", "Ocurrió un error al ingresar el entrenamiento");
