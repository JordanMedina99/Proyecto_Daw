...
public class VistaPruebasUserVigilante extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("formularios/vista_pruebas_user_vigilante.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
