...
public class IngresarCapitolioServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Crear un objeto Capitolio con los datos ingresados
            ...
            // Crear una instancia de CapitolioDao para realizar la inserción
            CapitolioDao capitolioDao = new CapitolioDao();

            // Insertar el capitolio en la base de datos
            capitolioDao.insertarCapitolio(capitolio);
            ...
            request.setAttribute("error", "Ocurrió un error al ingresar el capitolio");
