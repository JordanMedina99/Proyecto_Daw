...
public class ActualizarDificultadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Crear una instancia de DificultadDao para realizar la actualización
            DificultadDao dificultadDao = new DificultadDao();

            // Actualizar la dificultad en la base de datos
            dificultadDao.actualizarDificultad(dificultad);
            ...
            request.setAttribute("error", "Ocurrió un error al actualizar la dificultad");
