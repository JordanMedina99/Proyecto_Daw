...
/**
 * Servlet implementation class IngresarTributosServlet
 */
public class IngresarTributosServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Crear una instancia de TributosDAO para realizar la inserción
            TributosDao tributosDao = new TributosDao();

            // Insertar el tributo en la base de datos
            tributosDao.insertarTributo(tributo);
            ...
            request.setAttribute("error", "Ocurrió un error al ingresar el tributo");
