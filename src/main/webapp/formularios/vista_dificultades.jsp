...
<%@ page import="modelos.Dificultad" %>
...
<body>
  ...
  <a href="formularios/eliminar_dificultad.jsp" class="button">Eliminar</a>
  </div>
...
%>
<tr>
  <td><%= dificultad.getId_Dificultad() %></td>
  <td><%= dificultad.getdescripcion() %></td>
</tr>
<%
    }
  }
